...
const SignIn = () => {
  ...
  return (
    <div className="login font-comic">
      <div className="flex flex-col xl:flex-row xl:mx-[10vw] h-[100vh]">
        <div className="info flex xl:flex-col px-16 items-center bg-secondary-100 h-[55vh]">
          <div className="mb-4">
        ...
        <div className="form flex justify-around -mt-20">
          {isSignUp ? (
